<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.documents_contractor._default" EnableEventValidation="false"%>
            ...
            <div class="col-lg-12 col-xl-12 form-group">
                <div class="card mb-4">
                        ...
                        <div class="d-flex justify-content-between">
                              <h6 class="text-muted">
                               ...
                               <div class="col-md-6 col-lg-4 form-group text-right">
                                   ...
                                   <asp:Button ID="btnExportExcel" runat="server" Text="Export to Excel" CssClass="btn btn-primary" Visible="false" OnClick="btnExportExcel_Click"></asp:Button>
                    <asp:Button ID="btnback" runat="server" Text="Back To Dashboard" CssClass="btn btn-primary" PostBackUrl="/_content_pages/dashboard/"></asp:Button>
                                   <asp:Button ID="btnArchive" runat="server" Text="Archive" CssClass="btn btn-primary" Visible="false" OnClick="btnArchive_Click"></asp:Button>
                                  
                </div>
                          </div>
                            </div>
            <div class="container-fluid" id="ReportFilter2" runat="server" visible="false">
    <div class="row">
        <div class="col-md-6 mb-4" runat="server">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="card-body" >   
                            ...
                            <table style="width:100%;">
                                <tr>
                                   ...
                                   <td>&nbsp;</td>
                                    <td>
                                        <h6 class="card-title text-muted text-uppercase font-weight-bold">PMC Ref No.</h6>
                                    </td>
                                     <td>&nbsp;</td>
                                    <td>
                                        <h6 class="card-title text-muted text-uppercase font-weight-bold">Flow</h6>
                             ...
                             <tr>
                                ...
                                <tr>
                                    <td style="padding:5px"></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                                </tr>
                                <tr>
                                    <td>
                                        <h6 class="card-title text-muted text-uppercase font-weight-bold">Submittal Name</h6>
                                    </td>
                                     <td>&nbsp;</td>
                                    <td>
                                        <h6 class="card-title text-muted text-uppercase font-weight-bold">Document Name</h6>
                                    </td>
                                      <td>&nbsp;</td>
                                     <td id="tdOrglbl" runat="server" visible="false">
                                        <h6 class="card-title text-muted text-uppercase font-weight-bold">Originator Ref #</h6>
                                    </td>
                                     <td>&nbsp;</td>
                                    <td id="tdFileReflbl" runat="server" visible="false">
                                        <h6 class="card-title text-muted text-uppercase font-weight-bold">File Ref #</h6>
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        <asp:TextBox ID="TxtSubmittal" CssClass="form-control" runat="server" autocomplete="off" ClientIDMode="Static"></asp:TextBox>
                                    </td>
                                     <td>&nbsp;</td>
                                    <td>
                                       <asp:TextBox ID="TxtDocument" CssClass="form-control" runat="server" autocomplete="off" ClientIDMode="Static"></asp:TextBox> 
                                    </td>
                                      <td>&nbsp;</td>
                                    <td id="tdOrgtxtbox" runat="server" visible="false">
                                       <asp:TextBox ID="TxtOriginator" CssClass="form-control" runat="server" autocomplete="off" ClientIDMode="Static"></asp:TextBox> 
                                    </td>
                                    <td>&nbsp;</td>
                                     <td id="tdFileNumtxtbox" runat="server" visible="false">
                                       <asp:TextBox ID="TxtFileRefNo" CssClass="form-control" runat="server" autocomplete="off" ClientIDMode="Static"></asp:TextBox> 
                                    </td>
                                </tr>
                        </table>
                                </div>
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                           ...
                                           <asp:BoundField DataField="ProjectRef_Number" HeaderText="PMC Reference #" SortExpression="ProjectRef_Number">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
...
<ItemStyle Width="15%"></ItemStyle>
                                           ...
                                           <asp:TemplateField>
                                            ...
                                            <asp:TemplateField>
                                             ...
                                             <asp:TemplateField HeaderText="PMC Ref. No">
                                                 <ItemTemplate>
...
<ItemStyle CssClass="hideItem"></ItemStyle>
                                            ...
                                            <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <a class="showModalDocumentEdit" href="/_modal_pages/view-data-form2.aspx?DocID=<%#Eval("ActualDocumentUID")%>&pUID=<%#Eval("ProjectUID")%>&wUID=<%#Eval("WorkPackageUID")%>&type=search">View CommentSheet</a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-CssClass="hideItem" HeaderStyle-CssClass="hideItem">
                                                                    <ItemTemplate>
                                                                        <a class="showModalDocumentEdit" href="/_modal_pages/view-data-form1.aspx?DocID=<%#Eval("ActualDocumentUID")%>&pUID=<%#Eval("ProjectUID")%>&wUID=<%#Eval("WorkPackageUID")%>&type=search">View CRS</a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                           <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <a class="showModalDocumentMailNew" href="/_modal_pages/view-document-x.aspx?DocID=<%#Eval("ActualDocumentUID")%>&ProjectUID=<%#Eval("ProjectUID")%>&wUID=<%#Eval("WorkPackageUID")%>">View Review Files</a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                           <asp:TemplateField HeaderText="Archive">
                                                                    <ItemTemplate>
                                                                       <asp:CheckBox runat="server" ID="chkArchive"></asp:CheckBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                            <asp:TemplateField HeaderText="">
                                                                    <ItemTemplate>
                                                                       <asp:Button runat="server" ID="btnunarchive" Text="UnArchive" CssClass="btn btn-primary" Visible="false" CausesValidation="false" CommandArgument='<%#Eval("ActualDocumentUID")%>' CommandName="UnArchive"></asp:Button>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                            <asp:BoundField DataField="ArchivedBy" HeaderText="ArchivedBy" ItemStyle-CssClass="hideItem" HeaderStyle-CssClass="hideItem">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                       </Columns>
...
<HeaderStyle BackColor="#666666" ForeColor="White"></HeaderStyle>
    ...
    <div id="ModEditDocument" class="modal it-modal fade">
	    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
		    <div class="modal-content">
			    <div class="modal-header">
				    <h5 class="modal-title">View Comment Sheet</h5>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
			    </div>
			    <div class="modal-body">
                    <iframe class="border-0 w-100" style="height:500px;" loading="lazy"></iframe>
    ...
    <div id="ModGeneralDocumentEdit" class="modal it-modal fade">
     ...
     <div id="ModDocumentMailNew" class="modal it-modal fade">
	    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
		    <div class="modal-content">
			    <div class="modal-header">
				    <h5 class="modal-title">Cover Letter Or Review Files</h5>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
			    </div>
			    <div class="modal-body">
                    <iframe class="border-0 w-100" style="height:500px;" loading="lazy"></iframe>
