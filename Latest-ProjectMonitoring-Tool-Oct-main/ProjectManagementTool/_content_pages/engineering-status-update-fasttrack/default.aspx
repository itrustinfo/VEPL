<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.engineering_status_update_fasttrack._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="default_master_body" runat="server">
    ...
    <asp:UpdatePanel ID="Update1" runat="server" Visible="false">
                                <ContentTemplate>
                        <div class="row">                            
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="DDLMainTask" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLMainTask_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="col-md-12 col-lg-4 form-group" id="Task1" runat="server" visible="false">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="DDLSubTask" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLSubTask_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="col-md-12 col-lg-4 form-group" id="Task2" runat="server" visible="false">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="DDLSubTask1" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLSubTask1_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="col-md-12 col-lg-4 form-group" id="Task3" runat="server" visible="false">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="DDLSubTask2" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLSubTask2_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="col-md-12 col-lg-4 form-group" id="Task4" runat="server" visible="false">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="DDLSubTask3" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLSubTask3_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="col-md-12 col-lg-4 form-group" id="Task5" runat="server" visible="false">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="DDLSubTask4" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLSubTask4_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="col-md-12 col-lg-4 form-group text-right" id="Task6" runat="server" visible="false">
                        ...
                        <div class="col-md-12 col-lg-4 form-group text-right" id="Task7" runat="server" visible="false">
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <br />
                                             ...
                                             <div class="card-title">
                                            <div class="d-flex justify-content-between" id="divNonBOQMeasurment" runat="server">
                                ...
                                <div class="table-responsive">
                                    <div>
                                                ...
                                                <table class="table table-borderless">
                                                    <tr>
                                                        <td>
                                                            <asp:DropDownList ID="DDLResourceYear" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLResourceYear_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td><asp:DropDownList ID="DDLResourceMonth" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLResourceMonth_SelectedIndexChanged">
