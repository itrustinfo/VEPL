...
namespace ProjectManagementTool._content_pages.engineering_status_update_fasttrack
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        RDBStatusUpdateView.SelectedIndex = 1;
                        RDBStatusUpdateView_SelectedIndexChanged(sender, e);
                    }
        ...
        protected void ddlworkpackage_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                RDBStatusUpdateView.Items[0].Selected = false;
                RDBStatusUpdateView.Items[1].Selected = false;
        ...
        protected void DDLMainTask_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                DataSet ds = getdata.GetSubTasksForWorkPackages(DDLMainTask.SelectedValue);
        ...
        protected void DDLSubTask_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                DataSet ds = getdata.GetSubtoSubTasksForWorkPackages(DDLSubTask.SelectedValue);
        ...
        protected void DDLSubTask1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                DataSet ds = getdata.GetSubtoSubtoSubTasksForWorkPackages(DDLSubTask1.SelectedValue);
        ...
        protected void DDLSubTask2_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DDLSubTask2.SelectedValue != "--Select--")
            {
                ...
                DataSet ds = getdata.GetSubtoSubtoSubtoSubTasksForWorkPackages(DDLSubTask2.SelectedValue);
        ...
        protected void DDLSubTask3_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DDLSubTask3.SelectedValue != "--Select--")
            {
                ...
                DataSet ds = getdata.GetSubtoSubtoSubtoSubtoSubTasksForWorkPackages(DDLSubTask3.SelectedValue);
        ...
        protected void DDLSubTask4_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DDLSubTask4.SelectedValue != "--Select--")
            {
                ...
                DataSet ds = getdata.GetSubTask_By_ParentTask_Level(DDLSubTask4.SelectedValue, 7);
        ...
        protected void DDLSubTask5_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DDLSubTask5.SelectedValue != "--Select--")
            {
                ...
                DataSet ds = getdata.GetSubTask_By_ParentTask_Level(DDLSubTask5.SelectedValue, 8);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            divStatus.Visible = true;
            ActivityHeading.Text = "Task : " + SelectedTaskName;

            TaskScheduleHistory1.HRef = "/_modal_pages/view-measurement.aspx?TaskUID=" + ViewState["SelectedTaskUID"].ToString();
        ...
        private void BindTaskUpdates()
        {
            DataSet dsTask = getdata.GetTaskDetails(ViewState["SelectedTaskUID"].ToString());
            if (dsTask.Tables[0].Rows.Count > 0)
            {
                if (dsTask.Tables[0].Rows[0]["GroupBOQItems"].ToString() == "1")
                {
                    divStatus.Visible = false;
                    DailyUpdate.Visible = true;
                    SubTasksBind(ViewState["SelectedTaskUID"].ToString(), "1");
                    ActivitySchedule.Visible = false;
                    divNonBOQMeasurment.Visible = false;
                }
                else if (dsTask.Tables[0].Rows[0]["GroupBOQItems"].ToString() == "2")
                {
                    divStatus.Visible = false;
                    DailyUpdate.Visible = true;
                    SubTasksBind(ViewState["SelectedTaskUID"].ToString(), "2");
                    ActivitySchedule.Visible = false;
                    divNonBOQMeasurment.Visible = false;
                }
                else
                {
                    divStatus.Visible = true;
                    DailyUpdate.Visible = false;
                    LoadStatusRefersh(ViewState["SelectedTaskUID"].ToString());
                    LoadTaskResource(ViewState["SelectedTaskUID"].ToString());
                    LoadTaskMeasurementBook(ViewState["SelectedTaskUID"].ToString());
                    LoadMileStones(ViewState["SelectedTaskUID"].ToString());
                    LoadTaskSchedule(ViewState["SelectedTaskUID"].ToString());
                    YearBind(ViewState["SelectedTaskUID"].ToString());
                }
            }
        }
        ...
        private void LoadTaskSchedule(string TaskUID)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                TaskScheduleHistory.HRef = "/_modal_pages/view-measurement.aspx?TaskUID=" + ViewState["SelectedTaskUID"].ToString();
        ...
        protected void btnUpdateStatus_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                TaskUID = ViewState["SelectedTaskUID"].ToString();
        ...
        protected void btnScheduleUpdate_Click(object sender, EventArgs e)
        {
            if (DDLYear.SelectedValue != "" && DDLMonth.SelectedValue != "")
            {
                try
                {
                    ...
                    string TaskUID = ViewState["SelectedTaskUID"].ToString();
                    string sUnit = "";
                    ...
                    //
                    if (!string.IsNullOrEmpty(txtAchievedCurrent.Text))
                    {
                        if ((float.Parse(txtachieved.Text) + float.Parse(txtAchievedCurrent.Text) > Targetvalue))
                        {
                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Total achieved quantity cannot be greater than target quantity !.');</script>");
                    ...
                    {
                        Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please enter acieved quantity !.');</script>");
                        return;
                    }
        ...
        {
           if (DDLMonth.Items.Count > 0) DDLMonth.Items.Clear();
           if (DDLDay.Items.Count >0 ) DDLDay.Items.Clear();
            if (DDLYear.SelectedValue != "")
            {
                ...
                {
                   ds = getdata.GetworkpackageMonths_by_WorkpackageUID_Year(new Guid(ddlworkpackage.SelectedValue), Convert.ToInt32(DDLYear.SelectedValue),new Guid(ViewState["SelectedTaskUID"].ToString()));
                }
                else
                {
                    ds = getdata.GetTaskScheduleMonths_by_TaskUID_Year(new Guid(ViewState["SelectedTaskUID"].ToString()), Convert.ToInt32(DDLYear.SelectedValue));
                }
        ...
        private void ActivityTargetBind()
        {
            ...
            {
                DataSet ds = getdata.GetTaskSchedule_by_TaksUID_Month_Year(new Guid(ViewState["SelectedTaskUID"].ToString()), Convert.ToInt32(DDLMonth.SelectedValue), Convert.ToInt32(DDLYear.SelectedValue));
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        protected void RDBStatusUpdateView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlworkpackage.SelectedValue == "") return;
            ...
            if (RDBStatusUpdateView.SelectedValue == "Engineering")
            {
                ...
                DataSet ds = getdata.GetTasks_by_WorkpackageOptionUID(new Guid(ddlworkpackage.SelectedValue), new Guid("02f2ae06-d803-4e45-b09e-8c3c730c9f3f"));
        ...
        protected void DDLResourceYear_SelectedIndexChanged(object sender, EventArgs e)
        {
            GrdResourceDeployment.DataSource = null;
            GrdResourceDeployment.DataBind();
        }

        protected void DDLResourceMonth_SelectedIndexChanged(object sender, EventArgs e)
        {
            GrdResourceDeployment.DataSource = null;
            GrdResourceDeployment.DataBind();
