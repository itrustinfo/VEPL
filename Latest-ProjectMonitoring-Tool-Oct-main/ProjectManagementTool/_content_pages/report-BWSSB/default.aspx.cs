...
namespace ProjectManagementTool._content_pages.report_BWSSB
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (DDlProject.SelectedValue != "")
            {
                if (DDLFlow.SelectedIndex > 0)
                {
                    try
                    {
                        grdDataList.DataSource = getdt.usp_GetReportforBWSSBLetters(new Guid(DDLFlow.SelectedValue),DDLFlow.SelectedIndex);
                    }
                    catch(Exception ex)
                    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string HTMLstring = "<html><body>" +
                    ...
                    "<asp:Label ID='Lbl1' runat='server' Font-Bold='true'>" + WebConfigurationManager.AppSettings["Domain"] + " Report Name: Report for PMC letters/PMC comments added</asp:Label><br />" +
                ...
                string strFile = "Report_ReportPMC_" + DateTime.Now.Ticks + ".xls";
        ...
        private void ExporttoPDF(GridView gd, int type, string isPrint)
        {
            ...
            Phrase phApplicationName = new Phrase(Environment.NewLine + WebConfigurationManager.AppSettings["Domain"] + " Report Name: Reconciliation", FontFactory.GetFont("Arial", ApplicationNameSize, iTextSharp.text.Font.BOLD));
            ...
            else
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Report_PMC_" + DateTime.Now.Ticks + ".pdf");
                Response.End();
            }
        }
        ...
        void BindFlow()
        {
            DataTable ds = getdt.GetDocumentFlow().AsEnumerable().Where(r => r.Field<string>("Flow_Name").Equals("Contractor Correspondence-BWSSB") ||  r.Field<string>("Flow_Name").Equals("Contractor Correspondence-PMC")).CopyToDataTable();
