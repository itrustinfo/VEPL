<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.report_instruction._default" EnableEventValidation = "false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="default_master_body" runat="server">
    <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 col-lg-4 form-group">Instruction</div>
            ...
            <div class="row" style="text-align:center;">
                <div class="col-lg-12 col-xl-12" style="text-align:left;">
                    ...
                    <h6 id="HeadingSummary" runat="server" class="text-muted text-uppercase font-weight-bold">
                                   Instruction Summary(<asp:Label ID="LblTotalIssues" runat="server">0</asp:Label>)
                               </h6>
                    </div>
