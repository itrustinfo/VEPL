...
namespace ProjectManagementTool._content_pages.report_instruction
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        private void ExporttoPDF(GridView gd, int type,string isPrint)
        {
            try
            {
                ...
                Phrase phHeaderN = new Phrase("Report Name: Instructions (as on " + DateTime.Now.ToString("dd/MM/yyyy") + ")", FontFactory.GetFont("Arial", ApplicationNameSize, iTextSharp.text.Font.BOLD));
                ...
                else
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=Report_Instruction_" + DateTime.Now.Ticks + ".pdf");
                    Response.End();
                }
            }
            catch (Exception ex)
        ...
        protected void btnexcelexport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string HTMLstring = "<html><body>" +
                    ...
                    "<asp:Label ID='Lbl2' runat='server' Font-Bold='true'>" + WebConfigurationManager.AppSettings["Domain"] + " Report Name: Instructions Report (as on " + DateTime.Now.ToString("dd/MM/yyyy") + ") </asp:Label><br />" +
                ...
                string strFile = "Report_Instruction_" + DateTime.Now.Ticks + ".xls";
        ...
        private void LoadIssuesData()
        {
            ...
            try
            {
                headingReport.InnerHtml = "Report Name : Instructions";
                headingProject.InnerHtml = "Project Name : " + DDlProject.SelectedItem.Text + " (" + DDLWorkPackage.SelectedItem.Text + ")";
                ...
                DataSet ds = getdt.getIssuesList_by_WorkPackageUID_IssueStatus_type(new Guid(DDLWorkPackage.SelectedValue), status, DDLUser.SelectedValue, "Instruction");
                ...
                //GrdPrint.DataSource = ds;
                //GrdPrint.DataBind();
                LblTotalIssues.Text = "Total Issues/Instructions : " + dt.Rows.Count.ToString();
            }
            catch (Exception ex)
            {
                GrdIssues.DataSource = null;
                GrdIssues.DataBind();
                LblTotalIssues.Text = "Total Issues/Instructions : 0";
            }
        ...
        {
            DataSet ds = getdt.getAllUsers_ByIssueType(new Guid(DDLWorkPackage.SelectedValue), "Instruction");
