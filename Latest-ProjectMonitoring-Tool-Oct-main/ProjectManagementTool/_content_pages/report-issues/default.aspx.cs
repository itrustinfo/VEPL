    ...
    public partial class _default : System.Web.UI.Page
    {
        ...
        private void ExporttoPDF(GridView gd, int type,string isPrint)
        {
            try
            {
                ...
                Phrase phHeaderN = new Phrase("Report Name: Issues/Instructions (as on " + DateTime.Now.ToString("dd/MM/yyyy") + ")", FontFactory.GetFont("Arial", ApplicationNameSize, iTextSharp.text.Font.BOLD));
        ...
        protected void btnexcelexport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string HTMLstring = "<html><body>" +
                    ...
                    "<asp:Label ID='Lbl2' runat='server' Font-Bold='true'>" + WebConfigurationManager.AppSettings["Domain"] + " Report Name: Issues/Instructions Report (as on " + DateTime.Now.ToString("dd/MM/yyyy") + ") </asp:Label><br />" +
        ...
        private void LoadIssuesData()
        {
            ...
            try
            {
                headingReport.InnerHtml = "Report Name : Issues/Instructions";
                headingProject.InnerHtml = "Project Name : " + DDlProject.SelectedItem.Text + " (" + DDLWorkPackage.SelectedItem.Text + ")";
