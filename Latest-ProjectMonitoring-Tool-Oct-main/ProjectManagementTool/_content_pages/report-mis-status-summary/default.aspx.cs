...
namespace ProjectManagementTool._content_pages.report_mis_status_summary
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        {
            { "New 150 MLD STP-V Valley", new List<string>(){ "Submission Flow", "Contractor Correspondence-BWSSB", "Contractor Correspondence-PMC"}},
        ...
        private void BindData()
        {
            ...
            ReportName.InnerHtml = "MIS Status  Summary Report";
            ViewState["Export"] = "1";
        ...
        private DataTable ConstructDataTable()
        {
            ...
            dataTable.Columns.Add("Project Manager Review");
            dataTable.Columns.Add("Team Lead Review");
            dataTable.Columns.Add("Project Manager Code C");
            dataTable.Columns.Add("Project Manager Code D");
            ...
            dataTable.Columns.Add("DCE Approval");
            dataTable.Columns.Add("TA Approval");
            dataTable.Columns.Add("AE (ACE Flow) Approval");
