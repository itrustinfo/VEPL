    ...
    public partial class _default : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string HTMLstring = "<html><body>" +
                    ...
                    "<asp:Label ID='Lbl1' runat='server' Font-Bold='true'>" + WebConfigurationManager.AppSettings["Domain"] + " Report Name: Reconciliation</asp:Label><br />" +
                ...
                string strFile = "Report_Reconciliation_" + DateTime.Now.Ticks + ".xls";
        ...
        private void ExporttoPDF(GridView gd, int type, string isPrint)
        {
            ...
            else
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Report_Reconciliation_" + DateTime.Now.Ticks + ".pdf");
                Response.End();
            }
        }
        ...
        void BindFlow()
        {
            DataTable ds = getdt.GetDocumentFlow().AsEnumerable().Where(r => r.Field<string>("Flow_Name").Equals("Submission Flow")).CopyToDataTable();
