...
namespace ProjectManager._modal_pages
{
    public partial class add_document : System.Web.UI.Page
    {
       ...
       // protected static bool processComplete = false;
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    if (Request.QueryString["dUID"] != null)
                    {
                        ...
                        //added on 29/08/2023
                        dtIncomingRevDate.Text = DateTime.Now.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
                    }
                    else
                    {
                        //Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>parent.location.href=parent.location.href;</script>");
                    ...
                    if (Request.QueryString["fID"] != null)
                    {
                        ...
                        //
                        if (WebConfigurationManager.AppSettings["Domain"] == "ONTB" || WebConfigurationManager.AppSettings["Domain"] == "V-ValleySTP")
                        {
                            if(FlowType == "STP")
                            {
                        ...
                        if (dsFlow.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (dsDoc.Tables[0].Rows.Count > 0)
                            {
                                txtdesc.Text = dsDoc.Tables[0].Rows[0]["DocName"].ToString();
                                txtRefNumber.Text = dsDoc.Tables[0].Rows[0]["Doc_RefNumber"].ToString();
                            }
                          }
        ...
        {
            if (WebConfigurationManager.AppSettings["Domain"] == "ONTB" || WebConfigurationManager.AppSettings["Domain"] == "V-ValleySTP" || WebConfigurationManager.AppSettings["Domain"] == "Suez")
            {
                ...
                try
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (dsUser.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (WebConfigurationManager.AppSettings["Domain"] == "V-ValleySTP")
                            {
                            ...
                            sHtmlString += "<div style='width:100%; float:left;'><table style='width:100%;'>" +
                                            ...
                                            "<tr><td><b>Originator Reference Number </b></td><td style='text-align:center;'><b>:</b></td><td>" + txtRefNumber.Text + "</td></tr>" +
