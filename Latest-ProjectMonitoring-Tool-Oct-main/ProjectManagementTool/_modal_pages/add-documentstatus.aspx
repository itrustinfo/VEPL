...
<asp:Content ID="Content2" ContentPlaceHolderID="modal_master_body" runat="server">
    <form id="frmAddDocumentModal" runat="server">
        ...
        <div class="container-fluid" style="max-height:76vh; overflow-y:auto;" id="divmainsheet" runat="server" visible="true">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <asp:LinkButton runat="server" ID="lnkcommentsheet" OnClick="lnkcommentsheet_Click" Visible="false">View Comment sheet</asp:LinkButton>
        ...
        <div class="container-fluid" style="overflow-y:auto; min-height:85vh;" id="divcommentsheet" runat="server" visible="false">
        <div style="text-align:center;padding:10px"><h4><b>COMMENT SHEET</b></h4></div>
        <div class="row">
        <div class="col-lg-12">
       ...
       <table class="table table-bordered table-responsive">
            <thead>
                <tr class="col-12">
                    <th class="col-md-1">Contractor Letter Ref.No.</th>
                ...
                <tr class="col-12">
                    <th class="col-md-1">ONTB Ref.No.</th>
                            ...
                            <asp:TemplateField HeaderText="Comment">
                             <ItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server"
                                     Text= '<%# Eval("Comment") %>' BorderStyle="None" Width="100%" TextMode="MultiLine" Height="100px" ></asp:TextBox>
                            </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Comment">
                             <ItemTemplate>
                                <asp:CheckBox runat="server" ID="chkselectcomment"></asp:CheckBox>
                            </ItemTemplate>
                            </asp:TemplateField>
        ...
        <div class="modal-footer">
            <asp:Button ID="btnSaveComments" runat="server" Text="Save Comments" CssClass="btn btn-primary" OnClick="btnSaveComments_Click" Visible="false" />
                </div>
    </form>
</asp:Content>
