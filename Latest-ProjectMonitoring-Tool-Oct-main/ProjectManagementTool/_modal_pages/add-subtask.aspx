 ...
 $( function() {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //function IsScheduleTypeNull() {
            //    var scheduleType = document.getElementById("ddlScheduleType").value;
            //    if (scheduleType == "") {
            //        alert("Schedule Type is not selected");
            //        return false
            //    }
            //    else {
            //        return true;
                ...
                <div class="col-sm-6">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="lblCss" for="ddlSheduleType">Schedule Type</label>
                        <asp:DropDownList ID="ddlScheduleType" runat="server" CssClass="form-control">
                            <asp:ListItem Value =""><--Select Schedule Type--></asp:ListItem>
                            <asp:ListItem Value ="Month">Month</asp:ListItem>
                            <asp:ListItem Value ="Week">Week</asp:ListItem>
                        </asp:DropDownList>
                         <asp:label runat="server" ID="note" style="color:red"></asp:label>
                    </div>
