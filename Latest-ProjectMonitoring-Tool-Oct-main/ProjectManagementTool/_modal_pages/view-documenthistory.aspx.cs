...
namespace ProjectManagementTool._modal_pages
{
    public partial class view_documenthistory : System.Web.UI.Page
    {
        ...
        private void HideorShowAddStatusButton()
        {
            ...
            //
            afterloop:
            if (ds.Tables[0].Rows[0]["ActivityType"].ToString() == "sent to pmc")
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (Flowtype == "STP" || Flowtype=="STP-C" || Flowtype == "STP-OB")
                {
                    if (Session["IsContractor"].ToString() == "Y")
                    {
                        ...
                        else if (e.Row.Cells[3].Text == "Code A-EIC Approval")
                        {
                            e.Row.Cells[1].Text = "Approved By BWSSB Under Code A";

                        }
                        else if (e.Row.Cells[3].Text == "Code B-EIC Approval")
                        {
                    ...
                    else
                    {
                        ...
                        if (e.Row.Cells[3].Text == "Code A-CE Approval" || e.Row.Cells[3].Text == "Code A-EIC Approval")
                        {
                            e.Row.Cells[1].Text = "Approved By BWSSB Under Code A";

                        }
                        else if (e.Row.Cells[3].Text == "Code B-CE Approval" || e.Row.Cells[3].Text == "Code B-EIC Approval")
                        {
                            e.Row.Cells[1].Text = "Approved By BWSSB Under Code B";
                        }
                        else if (e.Row.Cells[3].Text == "Code C-CE Approval")
                        ...
                        if (e.Row.Cells[3].Text == "Sent to PMC" && prevstatus == "Accepted")
                        {

                        }
                        else if (e.Row.Cells[3].Text == "Sent to PMC")
                        {
                            e.Row.Cells[3].Text = "Accepted" + "<br/>" + "(Under PMC Review)";
                            e.Row.Cells[1].Text = "Review By ONTB";
                        }
                        else if (e.Row.Cells[3].Text == "Accepted-PMC")
                        {
                            e.Row.Cells[3].Text = "Accepted" + "<br/>" + "(PMC Review Completed)"; ;
                        }
