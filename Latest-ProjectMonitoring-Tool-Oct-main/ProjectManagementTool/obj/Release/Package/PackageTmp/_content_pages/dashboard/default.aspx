  ...
  overflow-y: hidden;
    ...
    <asp:Content ID="content_body" ContentPlaceHolderID="default_master_body" runat="server">
     ...
     <asp:ScriptManager ID="smMain" runat="server" EnablePageMethods="true" />
        ...
        <div class="container-fluid" id="DivSyncedData" runat="server" style="display:none">
        <div class="row">
          <div class="col-lg-6 col-xl-12 form-group">
                        <div class="card">
        ...
        <div class="row">
          <div class="col-lg-6 col-xl-12 form-group">
                        <div class="card">
                            <div class="card-body mb-3" style="padding-bottom:0; margin-bottom:0;">
                                <div class="row">
                        <div class="col-lg-4" style="text-align:left;font-size:large">
                          <b>Contractor Name : </b><asp:Label ID="lblContractor" runat="server" Text=""></asp:Label>
                        </div>   
                                      <div class="col-lg-4" style="text-align:left;font-size:large">
                                          <b>Project Name : </b><asp:Label ID="lblProject" runat="server" Text=""></asp:Label>     </div> 
                                     <div class="col-lg-2" style="text-align:left;font-size:large">
                                          <b>Project Start Date : </b><asp:Label ID="lblPStartDate" runat="server" Text=""></asp:Label>     </div> 
                                    <div class="col-lg-2" style="text-align:left;font-size:large">
                                          <b>Project End Date : </b><asp:Label ID="lblPEndDate" runat="server" Text=""></asp:Label>     </div> 
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                  <div class="col-md-6 col-xl-4 mb-4" id="divCostChart" runat="server">
                    <div class="card h-100">
                        <div class="card-body" style="background-color:#FFBB5C !important">
                                ...
                                <%--<h6 class="card-title text-muted text-uppercase font-weight-bold">Progress</h6>--%>
                                 ...
                                 <asp:Literal ID="ltScript_Progress" runat="server" Visible="true"></asp:Literal>
                                  <div id="chart_div" style="width:100%; height:330px; overflow-y: auto; overflow-x:scroll;background-color:#FFBB5C !important"></div>
              ...
              <div id="divsyncdetails" runat="server" visible="false" class="col-md-6 col-xl-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body" style="font-weight:900;background-color:#FFBB5C !important">
                            <h6 class="card-title text-muted text-uppercase font-weight-bold" style="color:forestgreen !important">Quick Access Links</h6>
                            <table style="width:100%;line-height:30px">
                                <tr id="ReconDocs" runat="server"><td><a href="#" id="hlReconciliationdocs" runat="server">Reconciliation Documents</a></td><td><asp:Label ID="lblReconDocs" runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblReconDocsNo" runat="server" Text="0"></asp:Label></td></tr>
                                 <tr><td><a href="#" id="hlContractor" runat="server">Total Documents</a></td><td><asp:Label ID="lblContractorTo" runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblContractorToNo" runat="server" Text="0"></asp:Label></td></tr>
                                ...
                                <tr id="trONTBTo" runat="server" visible="false"><td><a href="#" id="hlONTB" runat="server">Total Documents</a></td><td><asp:Label ID="lblONTBTo" runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblONTBTo_No" runat="server" Text="0"></asp:Label></td></tr>
                                 <tr><td><a href="#" id="hlMeasurement" runat="server">Measurments</a></td><td><asp:Label runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblMeasurements" runat="server" Text="0"></asp:Label></td></tr>
                                 <tr><td><a href="#" id="hlRABills" runat="server">RA Bills</a></td><td><asp:Label  runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblRABills" runat="server" Text="0"></asp:Label></td></tr>
                                 <tr><td><a href="#" id="hlInvoices" runat="server">Invoices</a></td><td><asp:Label runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblInvoices" runat="server" Text="0"></asp:Label></td></tr>
                                 <tr><td><a href="#" id="hlBankGuarantee" runat="server">Bank Guarantee</a></td><td><asp:Label runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblBankG" runat="server" Text="0"></asp:Label></td></tr>
                                 <tr><td><a href="#" id="hlInsurance" runat="server">Insurance</a></td><td><asp:Label runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblInsurance" runat="server" Text="0"></asp:Label></td></tr>
                                <tr><td><a href="#" id="hlInstructionManual" runat="server">Instruction Manual</a></td><td><asp:Label runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblInstruction" runat="server" Text="0"></asp:Label></td></tr>
                                 <tr><td><a href="#" id="hlMOM" runat="server">MOM Documents</a></td><td><asp:Label runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblMOM" runat="server" Text="0"></asp:Label></td></tr>
                                <tr><td><a href="#" id="hlArchived" runat="server">Archived Documents</a></td><td><asp:Label runat="server" Text=""></asp:Label></td><td><asp:Label ID="lblArchived" runat="server" Text="0"></asp:Label></td></tr>
               ...
               <div class="col-md-6 col-xl-4 mb-4" id="divIssues" runat="server">
                    <div class="card h-100">
                        <div class="card-body" style="background-color:#AEC3AE !important">
                            <h6 class="card-title text-muted text-uppercase font-weight-bold">Issues/Instructions</h6>
                ...
                <div class="col-md-6 col-xl-4 mb-4" style="display:none">
                    ...
                    <div class="col-md-6 col-xl-4 mb-4" id="divCamera" runat="server" style="display:none">
                    <div class="card h-100">
                        <div class="card-body" style="background-color:#AEC3AE !important">
    ...
    <div class="card h-100">
        <div class="card-body" style="background-color:#EBE76C !important">
            <a href="../engineering-status-update-fasttrack/default.aspx?fromdashboard=yes"<h6 class="card-title text-muted text-uppercase font-weight-bold" style="display: inline-block;">Status of Resource Deployment</h6></a>
            <div style="position: absolute; top: 5%; right: 5%;">
                <div style="display: inline-block; background-color: #1b9e77; width: 20px; height: 10px;"></div>
                <span style="margin-left: 5px;">Planned</span>
                <div style="display: inline-block; background-color: #7570b3; width: 20px; height: 10px; margin-left: 10px;"></div>
                <span style="margin-left: 5px;">Deployed</span>
            </div>

            <asp:Literal ID="ltScript_ResourceGraph" runat="server"></asp:Literal>

            <div id="ResourceChart_Div" style="width:100%; height:300px;overflow:scroll" visible="true">
                <!-- Your Google Chart will be rendered here. -->
                 ...
                 <div class="col-md-6 col-xl-4 mb-4" style="display:none">
                    ...
                    <div class="card h-100">
                        <div class="card-body" style="font-weight:800;background-color:#AEC3AE !important">
