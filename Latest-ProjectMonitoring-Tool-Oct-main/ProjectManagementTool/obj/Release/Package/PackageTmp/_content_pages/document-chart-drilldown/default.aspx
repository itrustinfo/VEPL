<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.document_chart_drilldown._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="default_master_body" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div><asp:Label ID="lblTotal" CssClass="text-uppercase font-weight-bold" runat="server" /></div>
