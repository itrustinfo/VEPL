...
<asp:Content ID="Content2" ContentPlaceHolderID="default_master_body" runat="server">
    ...
    <%--project selection dropdowns--%>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 col-lg-8 form-group">Issues/Instructions</div>
                                 ...
                                 <div class="col-md-6 col-xl-2 mb-2">
                                    <div class="card">
                                        <div class="card-body" id="divTotal" runat="server">
                                            <b style="font-size:large;"><a href="/_content_pages/issues?status=">Total No.</a></b>
                                            <br />
                                ...
                                <div class="col-md-6 col-xl-2 mb-2">
                                    <div class="card">
                                        <div class="card-body" id="divOpen" runat="server">
                                            <b style="font-size:large;"><a href="/_content_pages/issues?status=Open">Open</a></b>
                                            <br />
                                 ...
                                 <div class="col-md-6 col-xl-2 mb-2">
                                    <div class="card">
                                            <div class="card-body" id="divProgress" runat="server">
                                                <b style="font-size:large;"><a href="/_content_pages/issues?status=In-Progress">In-Progress</a></b>
                                                <br />
                                ...
                                <div class="col-md-6 col-xl-2 mb-2">
                                    <div class="card">
                                        <div class="card-body" id="divClosed" runat="server">
                                            <b style="font-size:large;"><a href="/_content_pages/issues?status=Close">Closed</a></b>
                                            <br />
                                ...
                                <div class="col-md-6 col-xl-2 mb-2">
                                    <div class="card">
                                        <div class="card-body" id="divRejected" runat="server">
                                            <b style="font-size:large;"><a href="/_content_pages/issues?status=Rejected">Rejected</a></b>
                                            <br />
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div>
                                                   <a id="AddIssues" runat="server" href="/_modal_pages/add-issues.aspx" class="showIssueModal"><asp:Button ID="Button2" runat="server" Text="+ Add Issues/Instructions" CssClass="btn btn-primary"></asp:Button></a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        ...
                                                        <asp:BoundField DataField="Issue_Description" HeaderText="Description&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" HeaderStyle-Width="40%" ItemStyle-Width="40%" >
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                           
<ItemStyle Width="30%"></ItemStyle>
                                                           
                                                        </asp:BoundField>
                                                          <asp:BoundField DataField="Type" HeaderText="Type" HeaderStyle-Width="10%" ItemStyle-Width="10%" >
                                                            <HeaderStyle HorizontalAlign="Left" />
...
<ItemStyle Width="20%"></ItemStyle>
                                                ...
                                                <asp:BoundField DataField="Issue_Date" HeaderText="Date of Occurrence" DataFormatString="{0:dd/MM/yyyy}">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                ...
                                                <HeaderStyle HorizontalAlign="Left" />
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <a target="_blank" href="/_modal_pages/preview-issue-documents.aspx?IssueUid=<%#Eval("Issue_Uid")%>"  >All Images Preview</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
...
<ItemStyle CssClass="hiddencol"></ItemStyle>
                                                       ...
                                                       <%-- <asp:TemplateField>
                                                         ...
                                                         <asp:TemplateField HeaderText="Reply By" ItemStyle-CssClass="hiddencol"  HeaderStyle-CssClass="hiddencol">
                                                            <ItemTemplate>
	    ...
	    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
		    <div class="modal-content">
			    <div class="modal-header">
				    <h5 class="modal-title">Add Issue/Instruction</h5>
    ...
    <div id="ModEditIssue" class="modal it-modal fade">
	    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
		    <div class="modal-content">
			    <div class="modal-header">
				    <h5 class="modal-title">Edit Issue/Instruction</h5>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
			    </div>
			    <div class="modal-body">
                    <iframe class="border-0 w-100" style="height: 460px;" loading="lazy"></iframe>
