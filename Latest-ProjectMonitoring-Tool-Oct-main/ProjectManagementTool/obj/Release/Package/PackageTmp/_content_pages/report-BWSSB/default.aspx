<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.report_BWSSB._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="default_master_body" runat="server">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 col-lg-3 form-group">BWSSB Reply Letters Document List</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <div id="divsummary" runat="server" visible="true">
                                    <div class="col-md-6 col-lg-3 form-group" style="font-weight:bold;font-size:medium;color:orangered">List of Documents for which BWSSB has replied</div>
