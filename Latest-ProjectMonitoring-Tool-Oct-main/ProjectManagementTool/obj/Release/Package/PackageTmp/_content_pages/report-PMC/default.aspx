<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.report_PMC._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="default_master_body" runat="server">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 col-lg-3 form-group">PMC Letters / PMC Comments Document List</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <div id="divsummary" runat="server" visible="true">
                                    <div class="col-md-6 col-lg-3 form-group" style="font-weight:bold;font-size:medium;color:orangered">List of Documents for which PMC has replied</div>
                                    ...
                                    <div style="overflow: scroll;" onscroll="OnScrollDivNew(this)" id="DivMainContentNew">
                                        <asp:GridView ID="grdDataList" EmptyDataText="No Data Found." runat="server" Width="100%" AutoGenerateColumns="false" CellPadding="6" CellSpacing="16" HeaderStyle-BackColor="#666666" HeaderStyle-ForeColor="White" AlternatingRowStyle-BackColor="#F5F5F5"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ProjectRef_Number" HeaderText="PMC Reference #">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
