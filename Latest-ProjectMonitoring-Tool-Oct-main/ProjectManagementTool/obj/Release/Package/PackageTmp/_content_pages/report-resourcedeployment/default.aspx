                        ...
                        <div class="card-body" >   
                            ...
                            <table style="width:80%;">
                              <tr>
                                  ...
                                  <td class="col-lg-02">
                                      <%--<h6 class="card-title text-muted text-uppercase font-weight-bold">Select Month</h6>--%>
                                      <asp:Label runat="server" ID="lbl4" ><b>Resource Name</b></asp:Label>
                                  </td>
                              </tr>
                             <tr>
                                 <td class="col-lg-02">
                                ...
                                <%-- <td>&nbsp;</td>--%>
                                 <td class="col-lg-02">
                                        <asp:DropDownList ID="DDLResourceType" runat="server" CssClass="form-control" OnSelectedIndexChanged="DDLResourceType_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Text="<---Select--->" Value="Select" />
                                        </asp:DropDownList>
                                 </td>
                                 <td class="col-lg-02">
                                        <asp:DropDownList ID="DDLResourceName" runat="server" CssClass="form-control" OnSelectedIndexChanged="DDLResourceName_SelectedIndexChanged" AutoPostBack="true">
                                            <asp:ListItem Text="<---Select--->" Value="Select" />
                                        </asp:DropDownList>
                                 </td>
                                <%-- <td>&nbsp;</td>--%>
            ...
            <div class="card mb-4">
                                    ...
                                    <h5 id="headingProject" runat="server">CP</h5>
                                        ...
                                        <div class="card-title">
                                             <div class="fa-pull-left" id="divTotal" runat="server"><label>Deployed Total :</label><asp:Label runat="server" ID="tDeployed"></asp:Label><label style="padding-left:10px">Total Plan : </label><asp:Label runat="server" ID="aDeployed"></asp:Label></div>
