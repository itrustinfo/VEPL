        ...
        <div class="container-fluid" style="max-height:80vh; overflow-y:auto;">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group" id="AcvitityName" runat="server">
                     ...
                     <div class="form-group">
                        <label class="lblCss" for="ddlType">Type</label> &nbsp;<span style="color:red; font-size:1.1rem;">*</span>
                         <asp:DropDownList ID="ddlType" CssClass="form-control"  runat="server" Visible="true">
                    ...
                    <div class="form-group">
                        <label class="lblCss" for="txtIssue_Description">Issue/Instruction Description</label> &nbsp;<span style="color:red; font-size:1.1rem;">*</span>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="lblCss" for="FileUploadDoc">Issue/Instruction Document</label>
