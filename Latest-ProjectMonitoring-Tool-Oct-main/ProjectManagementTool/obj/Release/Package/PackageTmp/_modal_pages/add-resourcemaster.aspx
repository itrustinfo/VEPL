                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="lblCss" for="DDLResourceType">Resource Type</label>
                         <asp:DropDownList ID="DDLResourceType" runat="server" CssClass="form-control" OnSelectedIndexChanged="DDLResourceType_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="true">
                          <asp:ListItem Text="<---Select--->" Value="Select" />
                         </asp:DropDownList>

                    </div>
                    <div class="form-group">
                        <label class="lblCss" for="DDLResourceName">Resource Name</label>
                         <asp:DropDownList ID="DDLResourceName" runat="server" CssClass="form-control" >
                     </asp:DropDownList>
                    </div>
