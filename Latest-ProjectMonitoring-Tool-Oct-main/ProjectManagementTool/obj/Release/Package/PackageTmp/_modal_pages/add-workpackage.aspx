  ...
  $( function() {
    $("input[id$='dtStartDate']").datepicker({
      ...
      dateFormat:'dd/mm/yy'
       ...
       $("input[id$='dtExtendedEndDate1']").datepicker({
      changeMonth: true,
        changeYear: true,
      dateFormat:'dd/mm/yy'
       });

       $("input[id$='dtExtendedEndDate2']").datepicker({
      changeMonth: true,
        changeYear: true,
      dateFormat:'dd/mm/yy'
       });

       $("input[id$='dtExtendedEndDate3']").datepicker({
      changeMonth: true,
        changeYear: true,
      dateFormat:'dd/mm/yy'
       });

       $("input[id$='dtExtendedEndDate4']").datepicker({
      changeMonth: true,
        changeYear: true,
      dateFormat:'dd/mm/yy'
    });
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="lblCss" for="dtExtendedEndDate1">Extended EndDate 1</label> &nbsp;<span style="color:red; font-size:1rem;">*</span>
                        <asp:TextBox ID="dtExtendedEndDate1" CssClass="form-control" runat="server" placeholder="dd/mm/yyyy" autocomplete="off" ClientIDMode="Static"></asp:TextBox>
                    </div>
                     <div class="form-group">
                        <label class="lblCss" for="dtExtendedEndDate2">Extended EndDate 2</label> &nbsp;<span style="color:red; font-size:1rem;">*</span>
                        <asp:TextBox ID="dtExtendedEndDate2" CssClass="form-control" runat="server" placeholder="dd/mm/yyyy" autocomplete="off" ClientIDMode="Static"></asp:TextBox>
                    </div>
                     <div class="form-group">
                        <label class="lblCss" for="dtExtendedEndDate3">Extended EndDate 3</label> &nbsp;<span style="color:red; font-size:1rem;">*</span>
                        <asp:TextBox ID="dtExtendedEndDate3" CssClass="form-control" runat="server" placeholder="dd/mm/yyyy" autocomplete="off" ClientIDMode="Static"></asp:TextBox>
                    </div>
                     <div class="form-group">
                        <label class="lblCss" for="dtExtendedEndDate4">Extended EndDate 4</label> &nbsp;<span style="color:red; font-size:1rem;">*</span>
                        <asp:TextBox ID="dtExtendedEndDate4" CssClass="form-control" runat="server" placeholder="dd/mm/yyyy" autocomplete="off" ClientIDMode="Static"></asp:TextBox>
                    </div>
